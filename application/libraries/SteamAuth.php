...
class SteamAuth
{
    protected $settings = array(
        "apikey" => "CE022AA4CA037D2EFBBD317EC4D18B20", // Get yours today from http://steamcommunity.com/dev/apikey
        "domainname" => "localhost", // Displayed domain in the login-screen
        "loginpage" => "http://localhost/irps_new/", // Returns to last page if not set
        "logoutpage" => "http://localhost/irps_new/",
